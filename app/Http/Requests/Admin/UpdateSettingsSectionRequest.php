    ...
    public function rules(): array
    {
        ...
        return match ($section) {
            ...
            'payments' => [
                ...
                'settings.payments.deposit_min_percent' => ['required', 'numeric', 'min:0', 'max:100'],
                'settings.payments.refund_auto_approve_limit' => ['required', 'numeric', 'min:0', 'max:10000000'],
                'settings.payments.wallet_overdraft_limit' => ['required', 'numeric', 'min:0', 'max:10000000'],
            ],
            'notifications' => [
            ...
            'seo_cms' => [
                ...
                'settings.seo_cms_defaults.package_visibility_default' => ['required', Rule::in(['visible', 'hidden'])],
                'settings.seo_cms_defaults.group_visibility_default' => ['required', Rule::in(['visible', 'hidden'])],
                'settings.seo_cms_defaults.homepage_banners_enabled' => ['required', Rule::in(['0', '1'])],
                'settings.seo_cms_defaults.landing_pages_enabled' => ['required', Rule::in(['0', '1'])],
                'settings.seo_cms_defaults.blog_enabled' => ['required', Rule::in(['0', '1'])],
            ],
            'maintenance' => [
                'settings.maintenance_flags.maintenance_enabled' => ['required', Rule::in(['0', '1'])],
                'settings.maintenance_flags.maintenance_banner_text' => ['required', 'string', 'max:300'],
            ],
            default => [],
        };
    }
